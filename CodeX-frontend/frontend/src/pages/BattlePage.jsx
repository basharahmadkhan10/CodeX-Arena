...
export default function BattlePage() {
  ...
  return (
    <div className="h-screen bg-[rgb(238,11,22)] flex flex-col overflow-hidden">
      {/* Header */}
      <header className="h-13 bg-[#ffffff] border-b-2 border-black flex items-center px-4 gap-4 shrink-0 z-10 py-2">
        <div className="flex items-center gap-2">
          <div className="w-7 h-7 bg-black text-[#ffffff] rounded flex items-center justify-center font-black text-sm">
            C
          </div>
        ...
        <div className="flex-1 flex items-center justify-center gap-4">
          ...
          <div className="bg-black text-[#ffffff] font-black text-xs px-3 py-1.5 rounded-lg border-2 border-black shadow-[2px_2px_0px_#000]">
            VS
          </div>
